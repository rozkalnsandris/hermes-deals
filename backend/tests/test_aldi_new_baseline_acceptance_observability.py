...
EXPECTED_REASON_CODES = {'BRIDGE_PATH_DRIFT', 'REQUEST_SHA256_MISMATCH', 'SANITIZED_OUTPUT_VALIDATION_FAILED', 'PRIMARY_REPOSITORY_NOT_MAIN', 'REGISTRATION_CONFIG_INVALID', 'DISPATCHER_NOT_ROOT', 'ARTIFACT_DIRECTORY_MISSING_OR_UNSAFE', 'ARTIFACT_DIRECTORY_MODE_INVALID', 'ARTIFACT_EXPORT_FAILED', 'BRIDGE_FILE_MISSING_OR_UNSAFE', 'INVALID_EXPECTED_MAIN_SHA', 'INVALID_GITHUB_RUN_ID', 'REQUEST_MEMBER_UNSAFE', 'REGISTRATION_CONFIG_FIELD_MISSING', 'REQUEST_ROOT_DRIFT', 'ARTIFACT_DIRECTORY_OUTSIDE_ALLOWLIST', 'SANITIZED_RESULT_MISSING', 'REQUEST_MEMBER_OWNERSHIP_INVALID', 'BRIDGE_OUTPUT_MISSING', 'PRIMARY_MAIN_SHA_DRIFT', 'ARTIFACT_DIRECTORY_NOT_EMPTY', 'PRIMARY_REPOSITORY_MISSING_OR_UNSAFE', 'BRIDGE_HASH_DRIFT', 'REQUEST_DIRECTORY_OWNERSHIP_INVALID', 'ARTIFACT_DIRECTORY_OWNERSHIP_INVALID', 'REQUEST_JSON_MISSING_OR_UNSAFE', 'GATE_HASH_DRIFT', 'INVALID_ARGUMENT_COUNT', 'GATE_FILE_MISSING_OR_UNSAFE', 'INVALID_REQUEST_SHA256', 'PRIMARY_ORIGIN_NOT_ALLOWLISTED', 'REGISTERED_MAIN_SHA_DRIFT', 'INVALID_AUTHORIZATION_COMMENT_ID', 'REQUEST_DIRECTORY_MISSING_OR_UNSAFE', 'REQUEST_JSON_OWNERSHIP_INVALID', 'PRIMARY_REPOSITORY_DIRTY', 'REQUEST_MEMBER_MODE_INVALID', 'REQUEST_DIRECTORY_MODE_INVALID'}
