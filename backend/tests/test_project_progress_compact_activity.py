...
def test_activity_keeps_counts_visible_and_collapses_long_issue_list() -> None:
    ...
    assert "**Development activity:** **Issues fixed:** **123 total** · **17 during the previous day** (08.08.2026)" in block
...
def test_activity_omits_empty_details_when_no_issues_closed_yesterday() -> None:
    ...
    assert "**Development activity:** **Issues fixed:** **123 total** · **0 during the previous day** (08.08.2026)" in block
