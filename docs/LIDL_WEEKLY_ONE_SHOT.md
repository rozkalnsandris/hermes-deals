...
- `READY`: exact official PDF/raw identity exists in the corpus, an authoritative
  scan exists, `review-profile.json` has status `reviewed`, and the SHA-gated
  V6.3.1 completeness dry-run succeeds.
