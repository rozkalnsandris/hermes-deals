...
AUDIT_NAME='origin-incident-evidence'
DISPATCH_TARGET='/usr/local/sbin/hermes-deals-origin-incident-evidence-dispatch'
COLLECTOR_TARGET='/usr/local/libexec/hermes-deals-audits/origin-incident-evidence.py'
CONF='/etc/hermes-deals-audits.d/origin-incident-evidence.conf'
SUDOERS='/etc/sudoers.d/hermes-deals-origin-incident-evidence'
...
COLLECTOR_SOURCE="$SOURCE_ROOT/tools/origin_incident_evidence.py"
DISPATCH_SOURCE="$SOURCE_ROOT/tools/runner/origin-incident-evidence-dispatcher.sh"
WORKFLOW_SOURCE="$SOURCE_ROOT/.github/workflows/origin-incident-evidence-rpi5.yml"
DOC_SOURCE="$SOURCE_ROOT/docs/operations/origin-incident-evidence-rpi5.md"
